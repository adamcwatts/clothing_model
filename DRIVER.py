...
class SolutionSetup:
    def __init__(self, fabric_ic):
        ...
        self.q_sorption = np.copy(zeros_array)
        self.q_condensation = np.copy(zeros_array)

        self.q_evaporation = np.copy(zeros_array)
        self.q_evaporation_history = np.copy(zeros_array)
